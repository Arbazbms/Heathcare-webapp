...
<html lang="en">
  ...
  <a class="navbar-brand" href="#" style="background-color: #F0A500">Health Care Management System </a>
...
.btn-primary{
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent" style="background-color: #F0A500">
  ...
  <body style="padding-top:50px;" style="background-color:grey">
  
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%;  padding-bottom: 20px; font-family: 'IBM Plex Sans', sans-serif; color:green"> Welcome &nbsp<?php echo $username ?> 
   </h3>
    <div class="row">
    ...
    <div class="tab-content" id="nav-tabContent" style="width: 950px;">
      ...
      <div class="tab-pane fade" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
        <div class="container-fluid">
          <div class="card" style="background-color:#F0A500">
            <div class="card-body" >
...
<div class="tab-pane fade" id="app-hist" role="tabpanel" aria-labelledby="list-pat-list" style="background-color:#F0A500">
      ...
      <div class="tab-pane fade" id="list-pres" role="tabpanel" aria-labelledby="list-pres-list" style="background-color:#F0A500">
